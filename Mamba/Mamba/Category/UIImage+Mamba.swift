...
extension UIImage {
    ...
    /// - Returns: image
    class func imageResized(name: String) -> UIImage {
        return imageResized(name: name, left: 0.5, top: 0.5)
    }
    /// resize image size
    /// - Parameters:
    ///   - name: image name
    ...
    ///   - top: top
    /// - Returns: image
    class func imageResized(name: String, left: CGFloat, top: CGFloat) -> UIImage {
